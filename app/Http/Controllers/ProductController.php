...
class ProductController extends Controller
{
            ...
            return DataTables::of($query)
                ->addColumn('action', function($item){
                    return '
                        ...
                        <a href="'. route('dashboard.product.edit', $item->id) .'" class="bg-gray-500 text-white rounded-md px-2 py-1 mr-2">
                            Edit
                        </a>
    ...
    public function store(ProductRequest $request)
    {
        ...
        Product::create($data); //versi untuk menyimpan product di laravel
