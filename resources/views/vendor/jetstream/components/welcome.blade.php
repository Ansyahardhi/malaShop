<div class="p-6 sm:px-20 bg-blue-100 border-b border-gray-200">
    <div>
        <x-jet-application-logo class="block h-12 w-auto" />
    </div>

    <div class="mt-8 text-4xl text-blue-700 text-center font-semibold">
        <marquee class="py-3" direction="left" onmouseover="this.stop()" onmouseout="this.start()">
            Selamat Datang Di Website Toko Mala Kosmetik
        </marquee>
    </div>

    {{-- <div class="mt-8 text-2xl text-gray-700 text-center font-bold">
        <br>Toko Kami Menyediakan Berbagai Jenis 
            <br> Produk Kecantikan Dari Berbagai Brand Ternama
    </div>

    <div class="border-t border-b border-gray-200 py-12 mt-16 px-4">
        <div class="flex justify-center mb-8">
            <img
                src="{{ url('frontend/images/content/toko-mala.jpg')}}"
                alt="Mala Kosmetik"
            />
        </div>
    </div>
